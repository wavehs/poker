...
class EquitySolver:
    ...
    def compute_range_vs_range_equity(
        ...
        # Pre-mark board cards
        for b in board_ints:
            forbidden[b] = True

        # Extract method to local variable to reduce attribute lookup overhead
        ...
        for _ in range(sims):
            ...
            # Draw board
            # ⚡ Bolt Optimization: Use random.choice with forbidden array instead of random.sample
            sampled_board = []
            ...
            # Evaluate villain
            # ⚡ Bolt Optimization: Manual list creation avoids dynamic constructor overhead
