...
class EquitySolver:
    ...
    def compute_range_vs_range_equity(
        ...
        # ⚡ Bolt Optimization: Hoist method lookup out of the hot loop
        ...
        for _ in range(sims):
            ...
            # Evaluate villain
            # ⚡ Bolt Optimization: Use list concatenation to avoid list() constructor
            ...
            # Evaluate hero hands
            # ⚡ Bolt Optimization: Use forbidden array instead of list lookups in loop.
            for h_hand in valid_h_hands:
                if forbidden[h_hand[0]] or forbidden[h_hand[1]]:
                    continue

                # ⚡ Bolt Optimization: Use fast array list concatenation
