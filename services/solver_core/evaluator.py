...
def _evaluate_five_int(c0: int, c1: int, c2: int, c3: int, c4: int) -> int:
    ...
    Optimized: no object allocations, no Counter, no sorted(), manual loop unrolling.
    """
    ...
    if r0 < r2: r0, r2 = r2, r0
    if r0 < r3: r0, r3 = r3, r0
    if r0 < r4: r0, r4 = r4, r0
    if r1 < r2: r1, r2 = r2, r1
    if r1 < r3: r1, r3 = r3, r1
    if r1 < r4: r1, r4 = r4, r1
    if r2 < r3: r2, r3 = r3, r2
    if r2 < r4: r2, r4 = r4, r2
    ...
    # count matches manual (since sorted, check adjacent elements)
    # 4 of a kind: 4-1 or 1-4
    if r0 == r3:
    ...
    # Pair: 2-1-1-1, 1-2-1-1, 1-1-2-1, 1-1-1-2
    if r0 == r1:
