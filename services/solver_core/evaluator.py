...
def _evaluate_five_int(c0: int, c1: int, c2: int, c3: int, c4: int) -> int:
    ...
    if v0 == v3:
        return _FOUR_KIND + v0 * 15 + v4
    if v1 == v4:
        return _FOUR_KIND + v1 * 15 + v0

    # Check for Full House
    if v0 == v2 and v3 == v4:
        return _FULL_HOUSE + v0 * 15 + v3
    if v0 == v1 and v2 == v4:
        return _FULL_HOUSE + v2 * 15 + v0

    # Check straight
    is_straight = False
    straight_high = -1
    if v0 - v4 == 4 and v0 != v1 and v1 != v2 and v2 != v3 and v3 != v4:
        is_straight = True
        straight_high = v0
