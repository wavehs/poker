...
class FastSolver(EquitySolver):
    def compute_range_vs_range_equity(self, hero_range_cards, villain_range_cards, community_cards, simulations=None):
        ...
        # We need an internal conversion here since _card_obj_to_int is not exported natively easily
        # But we can grab it from module or just recreate it locally.
        # Actually I can just monkey-patch or copy the logic to test.
...
def bench_range():
    ...
    print("Time taken for 1000 sims (optimized):", time.time() - t0)
